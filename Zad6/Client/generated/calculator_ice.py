...
_M_Demo._t_Calc1 = IcePy.defineValue('::Demo::Calc1', Ice.Value, -1, (), False, True, None, ())

if 'Calc1Prx' not in _M_Demo.__dict__:
    _M_Demo.Calc1Prx = Ice.createTempClass()
    class Calc1Prx(_M_Demo.CalcPrx):

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_Demo.Calc1Prx.ice_checkedCast(proxy, '::Demo::Calc1', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_Demo.Calc1Prx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::Demo::Calc1'
    _M_Demo._t_Calc1Prx = IcePy.defineProxy('::Demo::Calc1', Calc1Prx)

    _M_Demo.Calc1Prx = Calc1Prx
    del Calc1Prx

    _M_Demo.Calc1 = Ice.createTempClass()
    class Calc1(_M_Demo.Calc):

        def ice_ids(self, current=None):
            return ('::Demo::Calc', '::Demo::Calc1', '::Ice::Object')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Demo._t_Calc1Disp)

        __repr__ = __str__

    _M_Demo._t_Calc1Disp = IcePy.defineClass('::Demo::Calc1', Calc1, (), None, (_M_Demo._t_CalcDisp,))
    Calc1._ice_type = _M_Demo._t_Calc1Disp

    _M_Demo.Calc1 = Calc1
    del Calc1

_M_Demo._t_Calc2 = IcePy.defineValue('::Demo::Calc2', Ice.Value, -1, (), False, True, None, ())

if 'Calc2Prx' not in _M_Demo.__dict__:
    _M_Demo.Calc2Prx = Ice.createTempClass()
    class Calc2Prx(_M_Demo.CalcPrx):

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_Demo.Calc2Prx.ice_checkedCast(proxy, '::Demo::Calc2', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_Demo.Calc2Prx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::Demo::Calc2'
    _M_Demo._t_Calc2Prx = IcePy.defineProxy('::Demo::Calc2', Calc2Prx)

    _M_Demo.Calc2Prx = Calc2Prx
    del Calc2Prx

    _M_Demo.Calc2 = Ice.createTempClass()
    class Calc2(_M_Demo.Calc):

        def ice_ids(self, current=None):
            return ('::Demo::Calc', '::Demo::Calc2', '::Ice::Object')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Demo._t_Calc2Disp)

        __repr__ = __str__

    _M_Demo._t_Calc2Disp = IcePy.defineClass('::Demo::Calc2', Calc2, (), None, (_M_Demo._t_CalcDisp,))
    Calc2._ice_type = _M_Demo._t_Calc2Disp
