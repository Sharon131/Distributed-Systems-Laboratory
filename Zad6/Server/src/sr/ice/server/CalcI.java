...
public class CalcI implements Calc
{
	...
	{
		String full_id = id + " " + __current.id.category + "/" + __current.id.name;
		System.out.println(full_id + " ADD: a = " + a + ", b = " + b + ", result = " + (a+b));
	...
	public long subtract(int a, int b, Current __current) {
		String full_id = id + " " + __current.id.category + "/" + __current.id.name;
		System.out.println(full_id + " SUBTRACT: a = " + a + ", b = " + b + ", result = " + (a-b));
	...
	public /*synchronized*/ void op(A a1, short b1, Current current) {
		String full_id = id + " " + current.id.category + "/" + current.id.name;
		System.out.println(full_id + " OP" + (++counter));
